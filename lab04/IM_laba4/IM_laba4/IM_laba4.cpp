...
// Параметры как в классическом LCG (достаточно маленькие, нет переполнения)
const long long M = 2147483647;        // 2^31 - 1
const long long BETA = 48271;           // множитель (простое число)
...
public:
    ...
    double next() {
        ...
        // С параметрами M = 2^31-1 и a = 48271 переполнения нет:
        // 48271 * 2147483647 ≈ 1.04×10^14 < 2^63 ≈ 9.2×10^18
        x = (x * BETA) % M;
