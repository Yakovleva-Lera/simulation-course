...
| Вероятность простоя P₀ | 0,6153** | 1/(1+ρ) = 0,6000 |
| Вероятность занятости P₁ | 0,3847 | ρ/(1+ρ) = 0,4000 |
| Абсолютная пропускная способность A | 1,2015 | λ · P₀ = 1,2000 |
| Вероятность отказа P_отк | 0,3900 | P₁ = 0,4000 |
